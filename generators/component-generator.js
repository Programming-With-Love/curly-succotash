...
module.exports = plop => {
  ...
  plop.setGenerator('component', {
    ...
    actions: data => {
      ...
      const basePath = data.files.length ? '../src/components/{{pascalCase name}}/' : '../src/components/'
      ...
      ;[
        {
          condition: 'component',
          actions: [{ path: `${basePath}{{pascalCase name}}.tsx`, templateFile: 'templates/component-tsx.template' }],
        },
        {
          condition: 'test',
          actions: [
